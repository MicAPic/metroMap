...
PVeteranov = Station('Проспект Ветеранов', 'red')
LeninskyP = Station('Ленинский проспект', 'red')
Avtovo = Station('Автово', 'red')
KirovskyZ = Station('Кировский завод', 'red')
Narvskaya = Station('Нарвская', 'red')
Baltiyskaya = Station('Балтийская', 'red')
...
Chernyshevskaya = Station('Чернышевская', 'red')
PLenina = Station('Площадь Ленина', 'red')
Vyborgskaya = Station('Выборгская', 'red')
Lesnaya = Station('Лесная', 'red')
PMuzhestva = Station('Площадь Мужества', 'red')
Politeh = Station('Политехническая', 'red')
Akademicheskaya = Station('Академическая', 'red')
GrazdanskiyP = Station('Гражданский проспект', 'red')
Murino = Station('Девяткино', 'red')

Kupchino = Station('Купчино', 'blue')
Zvezdnaya = Station('Звездная', 'blue')
Moskovskaya = Station('Московская', 'blue')
ParkP = Station('Парк Победы', 'blue')
Elektrosila = Station('Электросила', 'blue')
MVorota = Station('Московские ворота', 'blue')
Frunzenskaya = Station('Фрунзенская', 'blue')
...
Gorkovskaya = Station('Горьковская', 'blue')
PSkaya = Station('Петроградская', 'blue')
ChRechka = Station('Чёрная речка', 'blue')
Pionerskaya = Station('Пионерская', 'blue')
Udelnaya = Station('Удельная', 'blue')
Ozerki = Station('Озерки', 'blue')
PProsvet = Station('Проспект Просвещения', 'blue')
Parnas = Station('Парнас', 'blue')
